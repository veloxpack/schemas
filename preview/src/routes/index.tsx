...
const SCHEMAS = [
  ...
  // Rclone Backends - Network Protocols
  {
    ...
    name: 'Rclone: SFTP',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/sftp.json',
    description: 'SFTP backend configuration',
  },
  {
    id: 'rclone-backend-ftp',
    name: 'Rclone: FTP',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/ftp.json',
    description: 'FTP backend configuration',
  },
  {
    id: 'rclone-backend-webdav',
    name: 'Rclone: WebDAV',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/webdav.json',
    description: 'WebDAV backend configuration',
  },
  {
    id: 'rclone-backend-smb',
    name: 'Rclone: SMB/CIFS',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/smb.json',
    description: 'SMB/CIFS backend configuration',
  },
  {
    id: 'rclone-backend-http',
    name: 'Rclone: HTTP',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/http.json',
    description: 'HTTP backend configuration',
  },
  {
    id: 'rclone-backend-hdfs',
    name: 'Rclone: HDFS',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/hdfs.json',
  ...
  // Rclone Backends - Special Purpose
  {
    ...
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/crypt.json',
    description: 'Encryption backend configuration',
  },
  {
    id: 'rclone-backend-chunker',
    name: 'Rclone: Chunker',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/chunker.json',
    description: 'Chunker backend configuration',
  },
  {
    id: 'rclone-backend-compress',
    name: 'Rclone: Compress',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/compress.json',
    description: 'Compress backend configuration',
  },
  {
    id: 'rclone-backend-union',
    name: 'Rclone: Union',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/union.json',
    description: 'Union backend configuration',
  },
  {
    id: 'rclone-backend-alias',
    name: 'Rclone: Alias',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/alias.json',
    description: 'Alias backend configuration',
  },
  {
    id: 'rclone-backend-cache',
    name: 'Rclone: Cache',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/cache.json',
    description: 'Cache backend configuration',
  },
  {
    id: 'rclone-backend-combine',
    name: 'Rclone: Combine',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/combine.json',
    description: 'Combine backend configuration',
  },
  {
    id: 'rclone-backend-hasher',
    name: 'Rclone: Hasher',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/hasher.json',
    description: 'Hasher backend configuration',
  },
  {
    id: 'rclone-backend-archive',
    name: 'Rclone: Archive Reader',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/archive.json',
    description: 'Archive Reader backend configuration',
  },
  {
    id: 'rclone-backend-memory',
    name: 'Rclone: Memory',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/memory.json',
  ...
  // Rclone Backends - File Hosting Services
  {
    ...
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/fichier.json',
    description: '1Fichier backend configuration',
  },
  {
    id: 'rclone-backend-internetarchive',
    name: 'Rclone: Internet Archive',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/internetarchive.json',
    description: 'Internet Archive backend configuration',
  },
  {
    id: 'rclone-backend-pikpak',
    name: 'Rclone: PikPak',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/pikpak.json',
    description: 'PikPak backend configuration',
  },
  {
    id: 'rclone-backend-putio',
    name: 'Rclone: Put.io',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/putio.json',
    description: 'Put.io backend configuration',
  },
  {
    id: 'rclone-backend-premiumizeme',
    name: 'Rclone: Premiumize.me',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/premiumizeme.json',
    description: 'Premiumize.me backend configuration',
  },
  {
    id: 'rclone-backend-ulozto',
    name: 'Rclone: Uloz.to',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/ulozto.json',
    description: 'Uloz.to backend configuration',
  },
  {
    id: 'rclone-backend-uptobox',
    name: 'Rclone: Uptobox',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/uptobox.json',
    description: 'Uptobox backend configuration',
  },
  {
    id: 'rclone-backend-pixeldrain',
    name: 'Rclone: Pixeldrain',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/pixeldrain.json',
    description: 'Pixeldrain backend configuration',
  },
  {
    id: 'rclone-backend-gofile',
    name: 'Rclone: GoFile',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/gofile.json',
    description: 'GoFile backend configuration',
  },
  {
    id: 'rclone-backend-linkbox',
    name: 'Rclone: Linkbox',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/linkbox.json',
  ...
  // Rclone Backends - Other
  {
    ...
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/googlephotos.json',
    description: 'Google Photos backend configuration',
  },
  {
    id: 'rclone-backend-sia',
    name: 'Rclone: Sia',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/sia.json',
    description: 'Sia backend configuration',
  },
  {
    id: 'rclone-backend-doi',
    name: 'Rclone: DOI Repositories',
    url: 'https://schemas.veloxpack.io/schemas/rclone/v1.71.2/backends/doi.json',

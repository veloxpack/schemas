...
import schema from "https://schemas.veloxpack.io/rclone/v1.71.2/schema.json";
...
```json
{
  ...
  "then": {
    "properties": {
      "backend_config": { "$ref": "https://schemas.veloxpack.io/rclone/${rclone_version}/backends/s3.json" }
    }
  }
}
```
